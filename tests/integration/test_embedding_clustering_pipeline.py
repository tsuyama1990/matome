...
def test_embedding_clustering_pipeline(
    ...
    config = ProcessingConfig(embedding_model="sentence-transformers/all-MiniLM-L6-v2", n_clusters=3, random_state=42)
    ...
    with patch("matome.engines.embedder.SentenceTransformer") as MockST:
        ...
        config = ProcessingConfig(
            embedding_model="sentence-transformers/all-MiniLM-L6-v2", n_clusters=3, random_state=42, embedding_batch_size=100
        )
